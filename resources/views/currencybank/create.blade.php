...
@section('title', 'Crear Banco Destino')

@section('content_header')
    <h1 class="m-0 text-primary text-center"><b>Crear nuevo Banco Destino</b></h1>
@stop

@section('content')
<form action="/currencybank" method="POST" id="view" name="view">
    @csrf
