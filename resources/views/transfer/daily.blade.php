...
@section('title', 'Transferencias del día')
...
@section('content_header')
    <h1 class="m-0 text-primary text-center"><b>Transferencias del día {{date('d-m-Y')}} <label class="text-danger">(Estatus: <i class="fas fa-traffic-light"></i> Transferido)</label></b></h1>
@stop
