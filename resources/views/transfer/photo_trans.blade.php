...
@section('content_header')
    <h1 class="m-0 text-primary text-center"><b>Capture (Print Screen) de la Transferencia Bancaria hecha</b></h1>
@stop

@section('content')
<form action="/transfer" method="POST" id="view" name="view" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header"><i class="fas fa-desktop"></i>
                    <b> Agregar capture de pantalla de la transferencia bancaria hecha</b>
                </div>
                <div class="card-body">
