...
@section('title', 'Crear Instrumento Bancario')

@section('content_header')
    <h1 class="m-0 text-primary text-center"><b>Crear nuevo Instrumento Bancario</b></h1>
@stop
