...
@section('content_header')
    <h1 class="m-0 text-primary text-center"><b>Créditos pendientes </b></h1>
@stop
...
<form action="/credit" method="POST" id="view" name="view" class="formeli">
    ...
    <input type="hidden" id="toaction" name="toaction" value="see_pendcredit">
    <div class="row">
                                ...
                                <table class="table table-striped table-bordered display responsive nowrap">
                                    <thead class="bg-dark text-white">
                                        <tr>
                                            ...
                                            <th class="text-center">Monto de la deuda</th>
                                    ...
                                    <tbody>
                                        @foreach ($datos as $dato)
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <label style="color: red; font-size:20px">{{$dato['net_amount']}}</label>
                                                </td>
