...
@section('content_header')
    <h1 class="m-0 text-primary text-center"><b>Editar País: </b><label class="text-dark">{{$countries->countryname}}</label></h1>
@stop

@section('content')
<form action="/country" method="POST" id="view" name="view" class="formeli">
    @csrf
    <input type="hidden" id="country_id" name="country_id" value="{{$countries->id}}">
                ...
                <div class="card-body">
                    <div class='row'>
                        <div class="col-md-10 form-group">
                            ...
                            <input type="text" class="form-control" id="countryname" name="countryname" onkeypress="quitaMensaje()" maxlength="80" value="{{ old('countryname') ?? $countries->countryname ?? old('countryname') }}" placeholder="Nombre del País" tabindex="1" autofocus>
                        ...
                        <div class="col-md-2 form-group">
                            ...
                            <input type="text" class="form-control" id="phone_code" name="phone_code" onkeypress="quitaMensaje()" maxlength="8" value="{{ old('phone_code') ?? $countries->phone_code ?? old('phone_code') }}" placeholder="Código WhatsApp" tabindex="2">
