...
@section('content_header')
    <h1 class="m-0 text-primary text-center"><b>Crear nuevo Banco</b></h1>
@stop

@section('content')
<form action="/bank" method="POST" id="view" name="view">
    @csrf
                ...
                <div class="card-body">
                    <div class='row'>
                        ...
                        <div class="col-md-5 form-group">
                            ...
                            <input type="text" class="form-control" id="bankname" name="bankname" onkeypress="quitaMensaje()" maxlength="50" value="{{ old('bankname') }}" placeholder="Nombre del Banco" tabindex="2">
                        ...
                        <div class="col-md-2 form-group">
                            ...
                            <input type="text" class="form-control" id="prefix" name="prefix" onkeypress="quitaMensaje()" maxlength="4" value="{{ old('prefix') }}" placeholder="Prefijo del Banco" tabindex="3">
                        </div>
                    </div>
