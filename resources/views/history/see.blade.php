...
@section('content_header')
    <h1 class="m-0 text-primary text-center"><b>Datos de la Transacción: <label style="color:black">{{$transactions[0]->account_holder}}</label></b></h1>
@stop
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 form-group">
                            <label for="amount_withheld" class="form-label" id="label_amount_withheld"><b>Retención en {{ trim($transactions[0]->currency) }}:</b> </label>
                        ...
                        @if ($transactions[0]->credit == 'N')
                            <div class="col-md-3 form-group">
                                <label for="net_amount" id="label_net_amount">Monto enviado en {{ trim($transactions[0]->currency) }}:</label>
                    ...
                    <div class="row">
                        <div class="col-md-2 form-group text-center">
                            <a href="/ret_history/{{$desde}}/{{$hasta}}" class="btn btn-secondary btn-block">Volver  <i class="fa fa-arrow-circle-left"></i></a>
                        </div>
                    </div>
                </div>
            </div>
