                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" class="form-control" id="customer_commission" name="customer_commission" onkeydown="quitaMensaje()" onKeyPress="solonumeros(event)" value="{{ old('customer_commission') }}" placeholder="% Comisión del Aliado Comercial">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" class="form-control" id="wholesaler_commission" name="wholesaler_commission" onkeydown="quitaMensaje()" onKeyPress="solonumeros(event)" value="{{ old('wholesaler_commission') }}" placeholder="% Comisión del Aliado Mayorista">
